...
const Hiring = () => {
    return (
        <svg width="110" height="110" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="Number_Three">
            <path id="Green_Accent_Three" fill-rule="evenodd" clip-rule="evenodd" d="M18 51C18 71.4345 34.5655 88 55 88L55 51L18 51Z" fill="#40F5D4"/>
            ...
            <defs>
            <filter id="filter0_d_186_24" x="0" y="0" width="110" height="110" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
